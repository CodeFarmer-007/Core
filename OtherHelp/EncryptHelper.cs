...
namespace OtherHelp
{
    ...
    public class EncryptHelper
    {
        ...
        {
            return DESEncrypt(Text, "YingChao", "YingChao");
        }
        ...
        {
            return DESEncrypt(Text, key, "YingChao");
        }
        ...
        public static string DESDecrypt(string Text)
        {
            ...
            {
                return DESDecrypt(Text, "YingChao", "YingChao");
            }
            else
            {
                return "";
        ...
        public static string DESDecrypt(string Text, string key)
        {
            if (!string.IsNullOrEmpty(Text))
            {
                return DESDecrypt(Text, key, "YingChao");
            }
            else
            {
                return "";
